document.addEventListener('DOMContentLoaded', () => {
    ...
    function gameLoop() {
        ...
        if (distance > 1) {
            ...
            // The 🚶 emoji faces left by default. scaleX(-1) makes it face right.
            if (dx > 1 && !isFacingRight) { // Moving right, but facing left
                isFacingRight = true;
                personEmoji.style.transform = 'scaleX(-1)'; // Flip to face right
            } else if (dx < -1 && isFacingRight) { // Moving left, but facing right
                isFacingRight = false;
                personEmoji.style.transform = 'scaleX(1)'; // Flip back to face left
            }
